// soma.vert.glsl
// Neuron cell body — vertex shader with simplex noise 3D displacement
// Ported 1:1 from vhxco-app.js lines 301-371 (snoise inline)
...
// 3D Simplex Noise — ported 1:1 from v0 (Classic Stefan Gustavson implementation)
